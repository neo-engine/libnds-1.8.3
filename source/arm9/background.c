...
bg_scroll* bgScrollTable[ 8 ]
    = { &BG_OFFSET[ 0 ],     &BG_OFFSET[ 1 ],     &BG_OFFSET[ 2 ],     &BG_OFFSET[ 3 ],

        &BG_OFFSET_SUB[ 0 ], &BG_OFFSET_SUB[ 1 ], &BG_OFFSET_SUB[ 2 ], &BG_OFFSET_SUB[ 3 ] };

bg_transform* bgTransform[ 8 ] = {
    (bg_transform*) 0, (bg_transform*) 0, (bg_transform*) 0x04000020, (bg_transform*) 0x04000030,

    (bg_transform*) 0, (bg_transform*) 0, (bg_transform*) 0x04001020, (bg_transform*) 0x04001030,
};
...
bool checkIfText( int id ) {
    ...
    if( mode == 1 || mode == 3 ) { return id == 3 || id == 7 ? false : true; }
